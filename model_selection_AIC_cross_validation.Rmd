...
# add new column named 'group' that contains the samples from the fold_vec that has a smaple size of the data frame (333), replace = FALSE guarantees that we will end up with exact distribution as seen in table
